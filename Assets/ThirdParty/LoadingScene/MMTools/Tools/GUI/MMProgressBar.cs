...
namespace MoreMountains.Tools
{
    ...
    public class MMProgressBar : MonoBehaviour
	{
		...
		public Color _color_healthMid;
		public Color _color_healthCritical;
			...
			if (ForegroundBar != null)
			{
                switch (FillMode)
                {
                    case FillModes.LocalScale:
                        ...
                        else if (BarProgress < .7f && BarProgress >= .4f)
                        {
	                        _foregroundImage.color = _color_healthMid;
                        }
                        else
                        {
	                        _foregroundImage.color = _color_healthCritical;
                        }
